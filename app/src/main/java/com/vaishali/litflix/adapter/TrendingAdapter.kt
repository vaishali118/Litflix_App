...
class TrendingAdapter(val context:Context,val itemList:List<Movies>):RecyclerView.Adapter<TrendingAdapter.TreadingViewHolder>() {
    class TreadingViewHolder(view: View):RecyclerView.ViewHolder(view)
    {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TreadingViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.movie_single_view,parent,false)
        return TreadingViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: TreadingViewHolder, position: Int) {
